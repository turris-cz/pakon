...
c.execute('create table if not exists "alerts" (start real, duration int, details int, src_ip text, src_port int, dest_ip text, dest_port int, proto text, app_proto text null, gid int, sid int, rev int, signature text, category text, severity int, bytes_send int, bytes_received int);')
